...
typedef marshal::eterm<EIXX_NAMESPACE::allocator_t>                  eterm;
typedef marshal::atom                                                atom;
typedef marshal::string<EIXX_NAMESPACE::allocator_t>                 string;
typedef marshal::binary<EIXX_NAMESPACE::allocator_t>                 binary;
typedef marshal::epid<EIXX_NAMESPACE::allocator_t>                   epid;
typedef marshal::port<EIXX_NAMESPACE::allocator_t>                   port;
typedef marshal::ref<EIXX_NAMESPACE::allocator_t>                    ref;
typedef marshal::tuple<EIXX_NAMESPACE::allocator_t>                  tuple;
typedef marshal::list<EIXX_NAMESPACE::allocator_t>                   list;
typedef marshal::map<EIXX_NAMESPACE::allocator_t>                    map;
typedef marshal::trace<EIXX_NAMESPACE::allocator_t>                  trace;
typedef marshal::var                                                 var;
typedef marshal::varbind<EIXX_NAMESPACE::allocator_t>                varbind;
typedef marshal::eterm_pattern_matcher<EIXX_NAMESPACE::allocator_t>  eterm_pattern_matcher;
typedef marshal::eterm_pattern_action<EIXX_NAMESPACE::allocator_t>   eterm_pattern_action;

namespace detail {
    BOOST_STATIC_ASSERT(sizeof(eterm)     == (alignof(uint64_t) > sizeof(int) ? alignof(uint64_t) : sizeof(int)) + sizeof(uint64_t));
